...
/*   Updated: 2024/03/01 14:28:31 by lgosselk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	update_tab_env(base, ft_strdup(new_value));
	update_linked_env(base, ft_strdup(new_value));
	free(base->curdir);
	base->curdir = ft_strdup(new_value);
    free(new_value);
}
// ;akhfkasfask;fhaklghsldkghsdklghsdklghsdgsdg TO FIXXXXXXXX!!!!!!